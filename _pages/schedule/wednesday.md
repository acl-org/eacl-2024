...
<div class="schedule" markdown="0">
  ...
  <div class="schedule-element">
    ...
    <div class="collapse-content schedule-element-content">
      ...
      <h3 class="collapse-toggle-button simple-link">Zoom Session DOC 1</h3>
      <div class="collapse-content">
        <strong>Chair:</strong> TBA<br/>
        <ul>
      ...
      <h3 class="collapse-toggle-button simple-link">Zoom Session INTERPRET</h3>
      <div class="collapse-content">
        <strong>Chair:</strong> TBA<br/>
        <ul>
  ...
  <div class="schedule-element">
    ...
    <div class="collapse-content schedule-element-content">
      ...
      <h3 class="collapse-toggle-button simple-link">Zoom Session GEN</h3>
      <div class="collapse-content">
        <strong>Chair:</strong> TBA<br/>
        <ul>
      ...
      <h3 class="collapse-toggle-button simple-link">Zoom Session IR/QA</h3>
      <div class="collapse-content">
        <strong>Chair:</strong> TBA<br/>
        <ul>
      ...
      <h3 class="collapse-toggle-button simple-link">Zoom Session ML</h3>
      <div class="collapse-content">
        <strong>Chair:</strong> TBA<br/>
        <ul>
      ...
      <h3 class="collapse-toggle-button simple-link">Zoom Session SYNTAX</h3>
      <div class="collapse-content">
        <strong>Chair:</strong> TBA<br/>
        <ul>
  ...
  <div class="schedule-element">
    ...
    <div class="collapse-content schedule-element-content">
      ...
      <h3 class="collapse-toggle-button simple-link">CSS+SENTIMENT 1</h3>
      <div class="collapse-content">
        <ul>
          ...
          <li>A New View of Multi-modal Language Analysis: Audio and Video Features as Text “Styles”</li>
      ...
      <h3 class="collapse-toggle-button simple-link">SEM 1</h3>
      <div class="collapse-content">
        <ul>
      ...
      <h3 class="collapse-toggle-button simple-link">MT-LRE 1</h3>
      <div class="collapse-content">
        <ul>
          ...
          <li>Continuous Learning in Neural Machine Translation using Bilingual Dictionaries</li>
      ...
      <h3 class="collapse-toggle-button simple-link">APPS 1</h3>
      <div class="collapse-content">
        <ul>
          <li>On the Calibration and Uncertainty of Neural Learning to Rank Models for Conversational Search</li>
          <li>Retrieval, Re-ranking and Multi-task Learning for Knowledge-Base Question Answering</li>
