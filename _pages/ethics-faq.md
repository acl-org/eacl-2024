...
# How is EACL 2023 handling ethics review?
...
- EACL reviewers are asked to consider the points listed in the ethics review questions page and then indicate whether a paper should be flagged for further ethics review and, if so, what considerations lead them to that recommendation.
...
# Can papers be rejected from EACL due to ethical concerns?
Yes.
...
Most of the text above comes from the EMNLP 2021 Ethics FAQ. We thank the EMNLP 2021 Ethics Chairs, Margot Mieskes and Christopher Potts for drafting the prior version.
